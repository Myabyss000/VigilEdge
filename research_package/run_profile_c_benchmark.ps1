...
$csv = 'research_package\benchmark_profile_c_requests.csv'
...
$summary | ConvertTo-Json | Out-File -FilePath 'research_package\benchmark_profile_c_summary.json' -Encoding utf8
$summary | Format-List
