...
def update_file(filepath):
    ...
    content = re.sub(r'<input[^>]+type="password"[^>]*>', repl, content, flags=re.DOTALL)
...
if __name__ == "__main__":
    update_file('ThreatLoom/dashboard/templates/login.html')
    update_file('ThreatLoom/dashboard/templates/reset_password.html')
